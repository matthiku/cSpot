            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group full-width">
                                {!! Form::label('church_youtube_playlist_id', 'Church YouTube Playlist ID:', ['class' => 'mb-0']) !!}<br>
                                {!! Form::text('church_youtube_playlist_id', env('CHURCH_YOUTUBE_PLAYLIST_ID')); !!}
                                <br><small>(playlist of songs for next event)</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card p-2">
                        <div class="card-body">
                            <h5 class="card-title">
                                Image for Blank Slide inserted between items during Presentation
                            </h5>
                            <p class="card-text">
                                <img src="{{ url('/') }}/images/background/blankslideimage.jpg" class="card-image-top" style="max-width:150px">
                                <span class="float-right">
                                    {!! Form::label('blank_slide', 'Upload a new one:'); !!}
                                    {!! Form::file('blank_slide'); !!}
                                </span>
                            </p>
                        </div>
                    </div>
