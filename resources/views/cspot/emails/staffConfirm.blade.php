...
<body>
    ...
    <h3><a href="{{ Config::get('app.url') . '/cspot/plans/'.$plan->id }}/team">{{ $plan->type->name }}
    ...
    <p>You can also <strong>quickly confirm</strong> this by clicking on
        <a href="{{ Config::get('app.url') . '/cspot/plans/'.$plan->id.'/team/'.$team->id.'/confirm/'.$team->remember_token }}">this link</a>.</p>
