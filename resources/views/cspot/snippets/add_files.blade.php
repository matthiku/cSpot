...
<div class="card">
    ...
    {{-- select a category 
    --}}
    <div class="card-block modal-select-file">
    ...
    --}}
    <div class="card-block center" id="show-location-selection" style="display: none;">

        <label class="card-text d-block">
    ...
    {{-- show images 
    --}}
    <div class="card-block center image-selection-slideshow" style="display: none;">

        <p class="mt-1">Selected category: <span class="text-info show-selected-category"></span></p>

        <label class="card-text d-block" id="images-for-selection-label"></label>
    ...
    --}}
    <div class="card-block center show-file-add-button"  style="display: none;">
