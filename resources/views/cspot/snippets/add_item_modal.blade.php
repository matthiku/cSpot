            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <a href="#" class="btn btn-lg btn-outline-success modal-pre-selection fully-width m-b-1 font-weight-bold"
                            onclick="showModalSelectionItems('scripture')">Scripture Text  </a>

                        <a href="#" class="btn btn-lg btn-outline-info modal-pre-selection fully-width m-b-1 font-weight-bold"
